        ...
        return (
            <div>
                <Prompt
                    ...
                    message={location => `你真的要切换到${location.pathname}地址吗?`}
                />
                <form onSubmit={this.handleSubmit}>
                    <div className="form-group">
                        <label htmlFor="username">用户名</label>
                        <input onChange={this.handleChange} ref={input => this.username = input} type="text"
                               className="form-control"/>
                    </div>
                    <div className="form-group">
                        <label htmlFor="password">密码</label>
                        <input onChange={this.handleChange} ref={input => this.password = input} type="text"
                               className="form-control"/>
                    </div>
                    <div className="form-group">
